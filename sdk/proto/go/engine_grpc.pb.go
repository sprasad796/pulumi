...
func (UnimplementedEngineServer) GetRootResource(context.Context, *GetRootResourceRequest) (*GetRootResourceResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetRootResource not implemented")
}
func (UnimplementedEngineServer) SetRootResource(context.Context, *SetRootResourceRequest) (*SetRootResourceResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SetRootResource not implemented")
}
func (UnimplementedEngineServer) StartDebugging(context.Context, *StartDebuggingRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method StartDebugging not implemented")
}
func (UnimplementedEngineServer) RequirePulumiVersion(context.Context, *RequirePulumiVersionRequest) (*RequirePulumiVersionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RequirePulumiVersion not implemented")
}
