...
func (c *analyzerClient) Cancel(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Analyzer_Cancel_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAnalyzerServer) AnalyzeStack(context.Context, *AnalyzeStackRequest) (*AnalyzeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AnalyzeStack not implemented")
}
...
func (UnimplementedAnalyzerServer) GetAnalyzerInfo(context.Context, *emptypb.Empty) (*AnalyzerInfo, error) {
	return nil, status.Error(codes.Unimplemented, "method GetAnalyzerInfo not implemented")
}
...
func (UnimplementedAnalyzerServer) ConfigureStack(context.Context, *AnalyzerStackConfigureRequest) (*AnalyzerStackConfigureResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ConfigureStack not implemented")
}
